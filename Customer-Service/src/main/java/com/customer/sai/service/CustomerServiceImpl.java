...
public class CustomerServiceImpl implements CustomerService {
	...
	@Override
	public Customer updateCustomer(Long customerId, Customer customer) throws NotFoundException {
		if(null == getCustomerById(customerId)) {
			throw new NotFoundException("Customer is not available to our system having id: "+customerId);
		}
